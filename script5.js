...
function applyFilters() {
  ...
  filteredPlayers = data.filter((player) => {
    const matchesSearch =
      ...
      player.points.toString().includes(searchValue) ||
      player.rebounds.toString().includes(searchValue) ||
      player.assists.toString().includes(searchValue);
...
tableBody.addEventListener("mouseover", (event) => {
  ...
  if (row) row.style.backgroundColor = "#dfe6e9";
});
